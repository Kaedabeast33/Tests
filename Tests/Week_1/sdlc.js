...
const design = "Developers will design UI System interfaces Network requirments and Databases and how it will fit together on a holistic level"
const implementation = "this is where the code is built"
const testingIntegration = "this is where we test for bugs"
const maintain = "fix any bugs on the user end level and or back end"