...
function canWeDeliver(zipcode){
    ...
    for(let i=0;i<deliveryAreaZipCodes.length;i++){
      if(zipcode===deliveryAreaZipCodes[i]){
        ...
        return zipcodes= true;}
      }

       
       console.log("Sorry we can't deliver to that location")
       return zipcodes=false;
}
console.log(canWeDeliver(852055))
...
dealsUpdated=deals[0].title.replace("15%","10%")
console.log(dealsUpdated)
...
dealsUpdatedTwo = deals[1].desc.replace("   ","").replace("March","April");
// dealsUpdatedTwoFr=dealsUpdatedTwo[1].desc.replace(`March`,"April");
console.log(dealsUpdatedTwo)