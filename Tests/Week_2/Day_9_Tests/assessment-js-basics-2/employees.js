...
let empOne = new Employee("Kaeden","weekday mornings, weekday afternoons");
/*
...
let empTwo = {...empOne}
empTwo.name.replace('Kaeden','Nick')
console.log(empTwo)
//////////////////PROBLEM 2////////////////////
/*  
...
let manager1=new Manager("Winston","All",["Cece","Schmidt"])
manager1.addEmployee("Kaeden")
